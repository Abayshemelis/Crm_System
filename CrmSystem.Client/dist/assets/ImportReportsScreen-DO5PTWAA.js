import{j as e,a as x}from"./index-CoEEMHiB.js";import{c as f,r as i}from"./vendor-CU1aK5H2.js";import{L as u}from"./Layout-Dq75mxUv.js";/* empty css                     */import{ae as v,F as h,aY as j,R as y,w,u as N,v as C,A as S}from"./icons-CZqQ2BlN.js";import"./signalr-BSDearS1.js";function k(t){const a=new Date().toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"}),r=`data_migration_report_${new Date().toISOString().split("T")[0]}.pdf`,s=window.open("","_blank");if(!s){alert("Please allow popups for this site to generate and download PDF reports.");return}const n=`
    <!DOCTYPE html>
    <html>
      <head>
