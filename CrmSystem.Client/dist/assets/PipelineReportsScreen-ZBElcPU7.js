import{u as re,j as e,a as C}from"./index-B0Yvr7-X.js";import{c as ne,r as s}from"./vendor-CU1aK5H2.js";import{L as le}from"./Layout-SZ4QbJHw.js";/* empty css                     */import{a9 as oe,F as de,aV as ce,R as pe,W as me,a6 as xe,aq as ge,aQ as he,C as G,K as ue,aX as be,S as fe,ak as ve,aA as ye}from"./icons-Wso9gVAh.js";import{R as E,C as T,X as O,Y as V,T as I}from"./CartesianChart-Bn2Og2IX.js";import{B as K,a as _,C as je}from"./BarChart-TJnjtq0N.js";import{A as Ne,a as Se}from"./AreaChart-BFvlAKLT.js";import"./signalr-BSDearS1.js";const H=["#6366f1","#3b82f6","#10b981","#f59e0b","#ec4899","#8b5cf6","#06b6d4"];function we(d,S,c,b,f,$,k){const v=new Date().toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"}),z=`pipeline_valuation_report_${new Date().toISOString().split("T")[0]}.pdf`,h=`$${f.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}`,y=window.open("","_blank");if(!y){alert("Please allow popups for this site to generate and download PDF reports.");return}const w=`
    <!DOCTYPE html>
    <html>
      <head>
